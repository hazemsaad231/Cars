...
const MyOrders = () => {
  ...
  return (
    ...
    <ToastContainer/>
    {loading ? <Loader />:
    <TableContainer component={Paper} sx={{ width: '80%', margin: 'auto', marginTop: '50px', marginBottom: '50px' ,backgroundColor: 'rgba(255, 255, 255, 0.7)', boxShadow: '10px 10px 10px 10px rgba(0.1, 0.1, 0.1, 0.1)'}} data-aos="fade-up">
        <Typography 
          variant="h5" 
          gutterBottom 
